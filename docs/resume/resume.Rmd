...
tribble(
  ...
  "Sr. Research Assistant", "2018-2021", "Federal Reserve Board of Governors", "Washington, DC","Assisting economists with data updates and maintenance, charting, and presentation preparations for Tealbook and briefings to governors.",
   "Sr. Research Assistant", "2018-2021", "Federal Reserve Board of Governors", "Washington, DC","Developed a program to identify household formation in Equifax Consumer Credit Panel for use in studying household credit allocation and decision making.",
   ...
   "Sr. Research Assistant", "2018-2021", "Federal Reserve Board of Governors", "Washington, DC","Maintained Board-wide Prediction Poll surveying staff on their predictions of various economic indicators. Produced visualizations for use in policy making.",
...
tribble(
   ~Type,
   "R, SAS, Stata, Python, Visual Basic, Java"
) %>% 
  brief_entries(
    Type
  )
